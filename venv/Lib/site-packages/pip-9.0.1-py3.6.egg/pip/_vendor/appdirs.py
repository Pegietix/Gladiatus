...
# - macOS: http://developer.apple.com/documentation/MacOSX/Conceptual
# /BPFileSystem/index.html
# - XDG spec for Un*x: http://standards.freedesktop.org/basedir-spec/basedir
# -spec-latest.html
...
def site_data_dir(appname=None, appauthor=None, version=None, multipath=False):
    ...
    Typical user data directories are:
        ...
        on Vista.)
        Win 7:      C:\ProgramData\<AppAuthor>\<AppName>   # Hidden,
